...
echo "<p>Bestrade Stock Viewing App<br>COMP-3512<br>Mount Royal University<br>Randy Connolly<br>Winter Semester 2021<br>Technologies Used: <br> GitHub <br> Heroku <br> FreeMYSQLHosting.net <br>";
